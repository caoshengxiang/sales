      ...
      <div class="com-info-left">
        ...
        <div class="com-info-text">
          ...
          <p>
            ...
            <span class="com-d-item">计划完结时间: <span>{{detail.limitTime && $moment(detail.limitTime).format('YYYY-MM-DD HH:mm:ss')}}</span></span>
          </p>
        </div>
      </div>
              ...
              <tr>
                <td>
                  <router-link class="col-link"
                               :to="{name: 'serviceCustomerDetail', query: {id: orderDetail.customerId, view: 'base'}}" target="_blank">
                    {{customerDetail.name}}
                  </router-link>
                </td>
