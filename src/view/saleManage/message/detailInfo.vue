<template>
  <div class="com-container">
    ...
    <div class="com-box com-box-padding com-list-box message-detail">
      <h3 class="title">服务商管理系统2018.03.06停机维护通知</h3>
      <div class="bar"><span class="span">系统消息</span><span class="span">{{$moment().format('YYYY-MM-DD HH:mm:ss')}}</span> <a class="del">删除消息</a></div>
      <div class="con">
