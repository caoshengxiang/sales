  ...
  <div class="com-dialog-container">
    <div class="com-dialog">
      <el-form :model="searchForm" ref="searchForm" label-width="110px">
        ...
        <el-row class="el-row-cla">
          <el-col :span="14">
            <el-form-item label="抽查派单时间：">
              <el-date-picker
                v-model="timeInterval"
                type="datetimerange"
                value-format="yyyy-MM-dd HH:mm:ss"
                @change="(value) => {this.timeBillDateIntervalHandle(value, 'assignTimeStart', 'assignTimeEnd')}"
                :unlink-panels="true"
                range-separator="至"
...
<script>
  ...
  export default {
    ...
    created () {
      ...
      /* 日期 */
      if (this.searchForm.assignTimeStart) { // 日期
        this.timeInterval = [this.searchForm.assignTimeStart, this.searchForm.assignTimeEnd]
      }
    },
  }
</script>
