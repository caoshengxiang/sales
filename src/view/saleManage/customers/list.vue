<template>
  <div class="com-container">
    ...
    <el-dialog title="新增客户" :visible.sync="addDialogVisible">
      <el-form :model="addCustomersForm">
        <el-form-item label="活动名称" label-width="100">
          <el-input v-model="addCustomersForm.name" auto-complete="off"></el-input>
        </el-form-item>
        <el-form-item label="活动区域" label-width="100">
          <el-select v-model="addCustomersForm.region" placeholder="请选择活动区域">
