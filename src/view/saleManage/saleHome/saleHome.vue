  ...
  <div class="sale-home">
    ...
    <div class="home-row">
      <el-row>
        <el-col :span="8">
          <div class="col-box">
            <p class="com-title">销售漏斗</p>
            <div style="width: 100%;height: 300px" id="funnelChart"></div>
          </div>
        </el-col>
        <el-col :span="8" class="lr-part">
          <div class="col-box">
            <p class="com-title">进击中的商机TOP5</p>
        ...
        <el-col :span="8">
          <div class="col-box">
            ...
            <div style="width: 100%; height: 300px" id="scatterChart"></div>
          </div>
        </el-col>
      </el-row>
    </div>
