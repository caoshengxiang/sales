...
<!--          <el-col :span="8">
          ...
          <el-col :span="4">
            <el-form-item label="资源类型：">
              <el-select v-model="searchForm.visitorType" placeholder="请选择资源类型">
          ...
          <el-col :span="4">
            <el-form-item label="访客来源：">
              <el-cascader
                :change-on-select="selectLastLevelMode"
                :options="customerSourceTypees"
                v-model="customerSourceArrs"
                @active-item-change="customerSourceChangeHandles"
                @change="customerSourceChangeHandles"
                :props="props"
                :value="selectedBindValue"
                :placeholder="searchForm.visitorResourceName"
              >
              </el-cascader>
            </el-form-item>
          </el-col>
        ...
        <el-row class="el-row-cla">
          <el-col :span="4">
            <el-form-item label="访客推荐人：">
              <el-select
                  v-model="searchForm.visitorReferrer"
                  filterable
                  clearable
                  placeholder="请选择">
          ...
          <el-col :span="4">
            <el-form-item label="客户ID：">
              <el-input type="text" v-model="searchForm.id" placeholder="客户ID"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
  ...
  export default {
    ...
    methods: {
      ...
      saveSubmitForm () {
        ...
        this.searchForm.visitorResourceName = this.traverseTree(this.searchForm.visitorResource)
      ...
      customerSourceChangeHandles (va) {
        this.getLastItem(this.customerSourceTypees, va, 'id')
        API.common.codeConfig({type: 5, pCode: va[va.length - 1]}, (data) => {
          if (data.data.length) {
            let arr = data.data.map((item) => {
        ...
        this.searchForm.visitorResource = va.join('-')
      },
