  ...
  export default {
    ...
    methods: {
      ...
      saveSubmitForm (formName) {
			let message = !this.addForm.customerName && '请输入客户名称' ||
                ...
                this.addForm.industry = this.addForm.industry ? this.addForm.industry : this.addForm.industryArr.join(',')
    ...
    created () {
      ...
      if (this.params.detail) { // 完善
        ...
        this.addForm.provinceId = this.detail.provinceId;
        this.addForm.cityId = this.detail.cityId;
        this.addForm.areaId = this.detail.areaId;
        this.addForm.provinceName = this.detail.provinceName;
        this.addForm.cityName = this.detail.cityName;
        this.addForm.areaName = this.detail.areaName;
        this.industryPlaceholder = this.detail.industry;
        this.addForm.industryArr = this.detail.industryIds ? this.detail.industryIds.split(',') : [];
        this.addForm.industry = this.detail.industryIds;
