          ...
          <el-tab-pane label="销售订单资料信息" name="detail">
            ...
            <table class="detail-table">
              ...
              <tr>
                ...
                <td class="td-title">客户推荐来源</td>
                <td>{{orderDetail.recommenderSourceName}}</td>
                <td class="td-title">客户推荐人</td>
  ...
  export default {
    ...
    methods: {
      ...
      handleTabsClick (tab, event) {
        ...
        this.$router.push(
          {name: 'salesOrdersDetail', params: {end: this.themeIndex === 0 ? 'FE' : 'ME'}, query: {view: tab.name, id: this.$route.query.id}})
      },
      operateOptions (op) {
        switch (op) {
          case 'edit':
