          ...
          <tr>
            ...
            <td class="td-text">
              <el-form-item prop="maxSeaFollower">
                <el-input-number v-model="form.maxSeaFollower" controls-position="right" :min="1" :max="999999"
                                 placeholder="请设置角色跟进公池客户最大数量"></el-input-number>
              </el-form-item>
            </td>
          </tr>
          <tr>
            ...
            <td class="td-text">
              <el-form-item prop="maxSeaFollowerPerMonth">
                <el-input-number v-model="form.maxSeaFollowerPerMonth" controls-position="right" :min="1" :max="999999"
                                 placeholder="请设置角色每月公池客户最大获取量"></el-input-number>
              </el-form-item>
            </td>
          </tr>
        </table>
